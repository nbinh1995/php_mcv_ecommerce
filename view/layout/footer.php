...
<div class="footer-top">
    <h3><i class="fas fa-truck" ></i> miễn phí giao hàng trên <span><?=number_format($about->delivery, 0, '', ',')?> VND*</span></h3>
...
<div class="footer-mid">
    <ul>
        <li><h2>sản phẩm</h2>
            <ul>
                ...
                <div class="ft-categories">
                    ...
                    <li><a href="shop">hàng <?=$menu->item_name?> mới về</a></li>
                    <li><a href="shop">hàng <?=$menu->item_name?> bán chạy</a></li>       
        ...
        <li> 
            ...
            <h5>Địa Chỉ Cửa Hàng: <?=$about->address?></h5>
        </li>    
    </ul>
</div>
